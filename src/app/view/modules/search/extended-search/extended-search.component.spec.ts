...
import {OntologyCacheService, OntologyMetadata} from "../../../../model/services/ontologycache.service";
...
describe('ExtendedSearchComponent', () => {
    ...
    beforeEach(async(inject([ExtendedSearchComponent, MockBackend], (component: ExtendedSearchComponent, mockBackend) => {
        ...
        let responses = {};
        responses['http://localhost:3333/v2/ontologies/metadata'] = new Response(new ResponseOptions({body: ontologyMetadata}));
        responses['http://localhost:3333/v2/ontologies/allentities/http%3A%2F%2F0.0.0.0%3A3333%2Fontology%2Fbeol%2Fv2'] = new Response(new ResponseOptions({body: classesAndPropsForBEOL}));
        responses['http://localhost:3333/v2/ontologies/allentities/http%3A%2F%2Fapi.knora.org%2Fontology%2Fknora-api%2Fv2'] = new Response(new ResponseOptions({body: classesAndPropsForKnoraApiOnto}));
    ...
    it('should correctly initialized the ontologies\' metadata', () => {
        ...
        const expectedOntoMetata =
            [new OntologyMetadata(
                ...
                'http://0.0.0.0:3333/ontology/beol/v2',
                'The BEOL ontology'
            ), new OntologyMetadata(
    ...
    /*it('should get the classes and properties for a specific ontology', async(inject([ExtendedSearchComponent, MockBackend], (component: ExtendedSearchComponent, mockBackend) => {
        ...
        componentInstance.getResourceClassesAndPropertiesForOntology('http://0.0.0.0:3333/ontology/beol/v2');
...
const classesAndPropsForBEOL = {
    "knora-api:hasOntologies" : {
        ...
        "knora-api:hasClasses" : {
            ...
            "beol:introduction" : {
                "@id" : "beol:introduction",
                "@type" : "owl:Class",
                "knora-api:canBeInstantiated" : true,
                "rdfs:comment" : "A resource representing an introduction",
                "rdfs:label" : "Einleitung",
                "rdfs:subClassOf" : [ "http://api.knora.org/ontology/knora-api/v2#Resource", {
                    "@type" : "owl:Restriction",
                    "owl:minCardinality" : 0,
                    "owl:onProperty" : "http://0.0.0.0:3333/ontology/beol/v2#hasSection"
                }, {
                    "@type" : "owl:Restriction",
                    "owl:minCardinality" : 0,
                    "owl:onProperty" : "http://0.0.0.0:3333/ontology/beol/v2#hasSectionValue"
                }, {
                    "@type" : "owl:Restriction",
                    "owl:maxCardinality" : 1,
                    "owl:onProperty" : "http://0.0.0.0:3333/ontology/beol/v2#hasText"
            ...
            "beol:person" : {
                ...
                "rdfs:subClassOf" : [ "http://api.knora.org/ontology/knora-api/v2#Resource", "http://xmlns.com/foaf/0.1/Person", {
                    "@type" : "owl:Restriction",
                    "owl:maxCardinality" : 1,
                    "owl:onProperty" : "http://0.0.0.0:3333/ontology/beol/v2#beolIDs"
                }, {
                    "@type" : "owl:Restriction",
                    "owl:minCardinality" : 0,
                    "owl:onProperty" : "http://0.0.0.0:3333/ontology/beol/v2#comment"
            ...
            "beol:section" : {
                ...
                "@type" : "owl:Class",
                "knora-api:canBeInstantiated" : true,
                "rdfs:comment" : "A resource representing a section",
                "rdfs:label" : "Sektion",
                "rdfs:subClassOf" : [ "http://api.knora.org/ontology/knora-api/v2#Resource", {
                    "@type" : "owl:Restriction",
                    "owl:minCardinality" : 0,
                    ...
                    "@type" : "owl:Restriction",
                    "owl:minCardinality" : 1,
                    "owl:onProperty" : "http://0.0.0.0:3333/ontology/beol/v2#sectionHasTitle"
                }, {
                    "@type" : "owl:Restriction",
                    "knora-api:isInherited" : true,
                    "owl:cardinality" : 1,
        ...
        "knora-api:hasProperties" : {
            "beol:beolIDs" : {
                ...
                "rdfs:comment" : "Represents IDs given to a person.",
                "rdfs:label" : "BEOL-IDs",
            ...
            "beol:hasFamilyName" : {
                ...
                "rdfs:label" : "Nachname",
                "rdfs:subPropertyOf" : [ "http://api.knora.org/ontology/knora-api/v2#hasValue", "http://xmlns.com/foaf/0.1/familyName" ]
            },
            "beol:hasFigure" : {
                "@id" : "beol:hasFigure",
                "@type" : "owl:ObjectProperty",
            ...
            "beol:hasGivenName" : {
                ...
                "rdfs:label" : "Vorname",
                "rdfs:subPropertyOf" : [ "http://api.knora.org/ontology/knora-api/v2#hasValue", "http://xmlns.com/foaf/0.1/givenName" ]
            },
            ...
            "beol:hasSection" : {
                ...
                "knora-api:isEditable" : true,
                "knora-api:isLinkProperty" : true,
                "knora-api:objectType" : "http://0.0.0.0:3333/ontology/beol/v2#section",
                "rdfs:comment" : "Repräsentiert ein Sektion",
                "rdfs:label" : "hat Sektion",
                "rdfs:subPropertyOf" : "http://api.knora.org/ontology/knora-api/v2#hasLinkTo"
            },
            "beol:hasSectionValue" : {
                "@id" : "beol:hasSectionValue",
                "@type" : "owl:ObjectProperty",
                "knora-api:isEditable" : true,
                "knora-api:isLinkValueProperty" : true,
                "knora-api:objectType" : "http://api.knora.org/ontology/knora-api/v2#LinkValue",
            ...
            "beol:sectionHasTitle" : {
                "@id" : "beol:sectionHasTitle",
                "@type" : "owl:ObjectProperty",
                "knora-api:isEditable" : true,
                "knora-api:objectType" : "http://api.knora.org/ontology/knora-api/v2#TextValue",
                "knora-api:subjectType" : "http://0.0.0.0:3333/ontology/beol/v2#section",
                "rdfs:comment" : "Titel",
                "rdfs:label" : "Titel",
        ...
        "knora-api:hasStandoffClasses" : {
            ...
            "beol:StandoffFontTag" : {
                "@id" : "beol:StandoffFontTag",
                "@type" : "owl:Class",
                "rdfs:comment" : "Represents font for special character",
                "rdfs:subClassOf" : [ "http://api.knora.org/ontology/knora-api/v2#StandoffTag", {
                    "@type" : "owl:Restriction",
                    "owl:minCardinality" : 1,
                    "owl:onProperty" : "http://0.0.0.0:3333/ontology/beol/v2#standoffFontType"
                }, {
                    "@type" : "owl:Restriction",
                    "knora-api:isInherited" : true,
                    "owl:cardinality" : 1,
        ...
        "knora-api:hasStandoffProperties" : {
            "beol:standoffFontType" : {
                "@id" : "beol:standoffFontType",
                "@type" : "owl:DatatypeProperty",
                "knora-api:subjectType" : "http://0.0.0.0:3333/ontology/beol/v2#StandoffFontTag",
                "rdfs:comment" : "Represents a webfont type for special character",
...
const classesAndPropsForKnoraApiOnto =
    {
        "knora-api:hasOntologies" : {
            "@id" : "http://api.knora.org/ontology/knora-api/v2",
            "@type" : "owl:Ontology",
            "knora-api:hasClasses" : {
                ...
                "knora-api:DateValue" : {
                    ...
                    "rdfs:subClassOf" : [ "http://api.knora.org/ontology/knora-api/v2#Value", {
                        ...
                        "@type" : "owl:Restriction",
                        "owl:cardinality" : 1,
                        "owl:onProperty" : "http://api.knora.org/ontology/knora-api/v2#dateValueHasEndEra"
                    }, {
                        "@type" : "owl:Restriction",
                        "owl:maxCardinality" : 1,
                        ...
                        "@type" : "owl:Restriction",
                        "owl:cardinality" : 1,
                        "owl:onProperty" : "http://api.knora.org/ontology/knora-api/v2#dateValueHasStartEra"
                    }, {
                        "@type" : "owl:Restriction",
                        "owl:maxCardinality" : 1,
