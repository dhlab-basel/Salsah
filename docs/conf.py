...
project = u'Salsah'
copyright = u'2016-2017, Digital Humanities Lab, University of Basel'
author = u'André Kilchenmann'
...
latex_documents = [
  (master_doc, 'Salsah.tex', u'Salsah: GUI for Knora',
...
man_pages = [
    (master_doc, 'salsah', u'Salsah: GUI for Knora',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Salsah', u'Salsah: GUI for Knora',
   author, 'André Kilchenmann', 'Salsah: GUI for Knora',
   'Miscellaneous'),
]
